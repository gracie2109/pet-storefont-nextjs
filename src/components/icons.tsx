...
export const Icons = {
    ...
    facebook_color: (props: IconProps) => (
        ...
        <>
            <svg {...props}>
                <g >
                    ...
                    <path
                        d="M20.9,6.51l.39.4-.39.39a.51.51,0,0,0,0,.72.51.51,0,0,0,.7,0l.4-.4.4.4a.51.51,0,0,0,.7,0,.51.51,0,0,0,0-.72l-.39-.39.39-.4a.5.5,0,0,0,0-.71.48.48,0,0,0-.7,0l-.4.4-.4-.4a.48.48,0,0,0-.7,0A.5.5,0,0,0,20.9,6.51Z"/>
                </g>
                {/*<text x="0" y="47" fill="#000000" font-size="5px" font-weight="bold"*/}
                {/*      font-family="'Helvetica Neue', Helvetica, Arial-Unicode, Arial, Sans-serif">Created by Anggah*/}
                {/*    Wahyu*/}
                {/*</text>*/}
    ...
    prs_403: (props: IconProps) => (
        <svg {...props}>
            <g fill="none" fillRule="evenodd">
                ...
                <path d="M87.782 115.821l15.73-3.012M100.165 115.821l10.04-2.008" stroke="#E4EBF7" strokeWidth="1.051"
                      strokeLinecap="round" strokeLinejoin="round"></path>
